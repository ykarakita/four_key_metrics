...
puts "CI実行時間: staging #{staging_ci_duration_seconds}秒 production #{master_ci_duration_seconds}秒"
puts "変更リードタイム: #{((total_lead_time / total_change_count + staging_ci_duration_seconds + master_ci_duration_seconds) / 60 / 60 / 24).round(3)}日"
